...
from tasks.srdiff_CT import CTDataSet
...
class RRDBTask(Trainer):
    ...
    def sample_and_test(self, sample):
        ...
        for b in range(img_sr.shape[0]):
            ...
            ret['n_samples'] += 1
        # print("sample_and_test_img_sr",img_sr.size())
...
class RRDBCTTask(RRDBTask):
    def __init__(self):
        super().__init__()
        self.dataset_cls = CTDataSet
